...
class Costumer extends CI_Controller {
  ...
  {
    $data['judul'] = 'Data Costumer';
    $data['get_kostumer'] = $this->m_user->get_all_kostumer();
    ...
    $this->load->view('backend/tb_costumer/index', $data, FALSE);
    $this->load->view('backend/layout/footer', $data, FALSE);
  }

  public function hapus($id_kostumer)
  {
    $this->db->delete('tb_kostumer', ['id_kostumer' => $id_kostumer]);
