...
class Auth extends BD_Controller {
  ...
  function __construct()
    {
        ...
        $this->methods['users_post']['limit'] = 50; // 100 requests per hour per user/key
  ...
  public function login_post()
  {
    ...
    if ($cek_userid == 2) {
      ...
      $this->response([
        'status' => false,
        'message' => 'Tipe user tidak diketahui!'
      ]); //response jika data tidak ditemukan
    }
  ...
  public function register_post()
  {
    ...
    if ($this->form_validation->run() == FALSE) {
      ...
      $output = $this->db->insert('tb_kostumer', $data);
